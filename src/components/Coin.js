...
<p><span className="F3F_ptagp">$NRGY on Ethereum</span> is an investment coin designed to<br/>
 ...
 <br/>
 <div className="coin_p_C2C row">
 <div className="col-2"><img src={Group6173} alt=""/></div><div className="col-10"><span className="F3F_ptagp">$NRGY's</span> high APY potential is attractive to investors and developers due to its limited supply and robust reward system.</div>
 </div>
 <p className="pt-5 see-on text-align-start">See On</p>
 <div className="coin_p_C2C coin-img-2 row">
 <div className="col-2 text-align-center"><img  src={image2} alt=""/></div><div className="col-10 pt-2">https://v2.info.uniswap.org/pair/0x51bf9908dac4a283<br/>d017edc071d954ec3a4b1376 </div>
 </div>
        </div>
        <div className="col-2"></div>
        </div>
